      ...
      <div v-if="activeClass" class="main-content">
        <div class="main-header">
          ...
          <div class="actions">
            ...
            <el-button type="success" plain @click="dialogBatchVisible = true">
        ...
        <el-table :data="filteredStudents" class="custom-table" :header-cell-style="{ background: '#f5f7fa', color: '#606266' }">
